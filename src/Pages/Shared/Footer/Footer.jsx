...
const Footer = () => {
    return (
        <footer className="px-4 w-full py-10 divide-y bg-gray-900 text-gray-100">
            <div className="container flex flex-col justify-between pt-20 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                ...
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    <div className="space-y-6">
                        <h3 className="tracking-wide uppercase text-gray-50">Products</h3>
                    ...
                    <div className="space-y-6">
                        <h3 className="uppercase text-gray-50">Guides</h3>
                        <ul className="space-y-3">
                            <li>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex ju3tify-start space-x-3">
            ...
            <div className="py-6 text-sm text-center text-gray-400">© 2023 Sokher Furnuture Company Co. All rights reserved.</div>
        </footer>
    );
};
