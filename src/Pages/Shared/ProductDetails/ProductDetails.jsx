    ...
    <section className="bg-slate-100">
      <div className="container md:pt-32 pt-20 max-w-xl mx-auto p-5 lg:px-8 lg:max-w-7xl">
        <div className="bg-white md:p-10 sm:p-5">
          <div className="grid lg:gap-8 lg:grid-cols-2 ">
            <div className="lg:col-start-2 flex flex-col justify-between p-5">
              <div className="">
                <h2 className="md:text-3xl text-2xl mb-2 font-bold tracking-tight sm:text-3xl ">
                  {name}
                </h2>
              ...
              <div className="flex gap-4 my-3">
                ...
                <div className="flex flex-col my-2">
                  <h2 className="text-3px font-bold">
                    Seller: {sellerName ? sellerName : "Not Found"}
                  </h2>
        ...
        <div className="bg-white shadow-2xl my-5 p-5">
          <h2 className="md:text-3xl text-lg mb-5 font-semibold tracking-tight sm:text-3xl ">
