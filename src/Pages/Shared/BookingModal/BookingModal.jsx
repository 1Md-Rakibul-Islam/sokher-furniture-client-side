        ...
        <div className="modal-box">
          ...
          <form onSubmit={handelBooking} className="">
            ...
            <div className="form-control w-full mt-1">
                <label htmlFor="label"> <span>Product Name</span></label>
            ...
            <div className="form-control w-full mt-1">
                ...
                <input name="buyerName" type="text" defaultValue={user?.displayName} disabled placeholder="Your name" className="input input-bordered w-full" />
            </div>

            <div className="form-control w-full mt-1">
                <label htmlFor="label"> <span>Email</span></label>
                <input name="buyerEmail" type="text" defaultValue={user?.email} disabled placeholder="Your email" className="input input-bordered w-full" />
            </div>
            <div className="form-control w-full mt-1">
                <label htmlFor="label"> <span>Price</span></label>
                <input name="reselPrice" type="text" defaultValue={reselPrice} disabled placeholder="Your email" className="input input-bordered w-full" />
            </div>
            <div className="form-control w-full mt-1">
                <label htmlFor="label"> <span>Phone</span></label>
                <input name="buyerPhoneNumber" type="number" placeholder="Your phone number" className="input input-bordered w-full" />
            </div>
            <div className="form-control w-full mt-1">
                <label htmlFor="label"> <span>Location</span></label>
