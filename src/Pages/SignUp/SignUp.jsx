    ...
    return (
        ...
        <div className="card border w-80 md:w-96 shadow-2xl p-7">
          ...
          <form onSubmit={handleSubmit(handelSignUp)}>
              ...
              <div className="form-control w-full mt-5">
                  <label htmlFor="label"> <span>Photo</span></label>
              ...
              <div className="form-control w-full mt-5">
                  <label htmlFor="label"> <span>Buyer/Seller</span></label>
                  <select 
                    {...register('option', {
                      required: true
                    })}
                    className="select select-bordered mt-5">
                    <option disabled selected>Whis account are you want to create?</option>
          ...
          <button onClick={handelGoogleLogin} className="btn text-3xl text-success btn-outline btn-circle"><FaGoogle></FaGoogle></button>
          </div>
        </div>
      </div>
    );
