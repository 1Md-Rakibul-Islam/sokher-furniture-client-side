          ...
          {bannerData2?.map((banner) => (
            <div className="flex items-center w-full">
              <div className="w-[40vw] md:w-[40vw] md:h-[90vh] h-[30vh] bg-purple-900 md:px-10 px-2 flex sm:justify-center justify-evenly items-start flex-col gap-y-2 md:gap-y-5">
                <h2 className="md:text-[3.5em] text-[1.2em] font-bold text-white mt-5">
                  {banner?.title}
                </h2>
                <h2 className="md:text-[1.2em] text-sm font-semibold text-white">
                  {" "}
                  Up to $30 off your first order
                </h2>
                <button className="btn md:btn-md btn-sm btn-outline bg-white rounded-full mb-5">
                  Order Now
                </button>
              </div>

              <img
                className="w-[60vw] md:w-[60vw] md:h-[90vh] h-[30vh]"
                src={banner?.image}
              />
            </div>
          ))}
